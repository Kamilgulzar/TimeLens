...
/* eslint-disable @typescript-eslint/no-explicit-any -- vendored WebGL component */
...
class App {
  ...
  constructor(container: HTMLElement, options: HyperspeedOptions, bloomThreshold = 0.2) {
    this.options = options;
...
const Hyperspeed: FC<HyperspeedProps> = ({
  ...
  useEffect(() => {
    ...
    const myApp = new App(container, options, bloomThreshold);
